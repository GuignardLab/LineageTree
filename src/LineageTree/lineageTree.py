...
class lineageTree(object):
    ...
    def to_treex(self, sampling=1,start=0,finish=10**9,many=False):
            ...
            start: What timepoint the tree should start, if many is True
            then many trees will exist, if False all the new trees will have one root node
            finish: what timepoint should the trees finish
